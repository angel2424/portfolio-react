  ...
  return (
    <header ref={boxRef}>
      <div className="flex jc-sb ai-c header">
        <a
          href="/"
          className={`cursor-link opacity-anim logo s ${
            scroll ? "logo--active" : ""
          }`}
        >
          <img
        ...
        <div
          className={`nav_container ${
            isOpen ? "nav_container--active" : ""
          } flex ai-c jc-sb`}
        >
          <nav className="nav flex ai-c">
            <a
              className="menu-font opacity-anim title"
              onClick={toggleMenu}
              href="/"
            >
              <span className="title-anim cursor-link">{t("header.home")}</span>
            </a>
            <a
              className="menu-font opacity-anim title"
              onClick={toggleMenu}
              href="/portfolio"
            >
              <span className="title-anim cursor-link">
                {t("header.portfolio")}
              </span>
            </a>
            <a
          ...
          <div className="nav_icons flex cursor-link opacity-anim">
            <a
              target="_blank"
              rel="noreferrer"
              href="https://www.instagram.com/a.rdzcodes24/"
            >
              <FaInstagram size={23} />
            </a>
            <a href="/">
          ...
          <div className="nav_toggles">
            ...
            <button className="bulb cursor-link" onClick={toggleTheme}>
              <img
                className="cursor-link"
                src={`${theme === "dark" ? off : on}`}
                alt=""
              />
            </button>
          </div>
        ...
        <div
          className={`hamburger cursor-link opacity-anim ${
